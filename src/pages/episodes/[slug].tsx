...
// da forma como estão estruturadas as pastas este arquivo nos permite
// acessar localhost/episodes/QUALQUERCOISA (futuramente serão os nomes dos episodios)
...
export const getStaticProps: GetStaticProps = async (context) => {
  ...
  return {
    ...
    revalidate: 60 * 60 * 24, // renovação à cada 24 hrs
  };
};
